...
export const detectOperator = (phone: string): Operator => {
...
export const getOperatorColor = (operator: Operator): string => {
  switch (operator) {
...
export const getOperatorBorder = (operator: Operator): string => {
  switch (operator) {
