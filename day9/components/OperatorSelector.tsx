...
interface Props {
  selected: Operator | 'All';
  onSelect: (op: Operator | 'All') => void;
}

const operators: (Operator | 'All')[] = ['All', 'Jio', 'Airtel', 'Vi', 'BSNL'];

const OperatorSelector: React.FC<Props> = ({ selected, onSelect }) => {
  return (
